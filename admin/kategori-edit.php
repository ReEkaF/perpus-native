...
if (isset($_POST['submit'])) {
    ...
    if (!$errors) {
        update_category($cat['id_kategori_buku'], $_POST);
        header('Location: ./kategori.php');
        exit();
    }
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            <nav class="text-sm text-gray-500 mb-4">
                ...
                <a href="" class="text-black-500 hover:underline"><b>Edit Kategori Buku</b></a>
            </nav>
            <h3 class="text-lg font-semibold mb-4">Edit Kategori Buku</h3>

            <!-- Form untuk menambah kategori -->
            <form action="./kategori-edit.php?id_kategori_buku=<?= $cat['id_kategori_buku']?>" method="post" class="space-y-4">
                <div>
